...
import { VehicleComponent } from '../good-component-design/vehicle/vehicle.component';
...
@Component({
  selector: 'app-vehicle-footer',
  imports: [CommonModule, VehicleComponent, AllMaterialModule,FooterComponent],
...
export class VehicleFooterComponent implements IFooter {
  ...
  subscribeSave() {
    ...
    this.sub.asObservable().pipe(
      ...
      tap(()=>console.log('Vehicle Data saved'))
    )
      .subscribe(() => {
        this.refresh();
      });
